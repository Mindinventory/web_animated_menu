...
class RightToLeftMenu extends StatefulWidget {
  final Widget child;
  final int index;
  final bool hovered;
  ...
  @override
  _RightToLeftMenuState createState() => _RightToLeftMenuState();
}

class _RightToLeftMenuState extends State<RightToLeftMenu>
