...
class SpringAcrossAxisMenu extends StatefulWidget {
  final Widget child;
  final int index;
  final bool hovered;
  ...
  @override
  _SpringAcrossAxisMenuState createState() => _SpringAcrossAxisMenuState();
}

class _SpringAcrossAxisMenuState extends State<SpringAcrossAxisMenu> with SingleTickerProviderStateMixin {
              ...
              if (value.connectionState == ConnectionState.done) {
                return TweenAnimationBuilder(
                  ...
                  builder: (_, double value, _child) {
                    return SpringAcrossAxisMenuTile(
                      value: value,
                      child: _child!,
                      index: i,
                    );
...
class SpringAcrossAxisMenuTile extends StatelessWidget {
  final int index;
  final double value;
  final Widget child;

  const SpringAcrossAxisMenuTile(
