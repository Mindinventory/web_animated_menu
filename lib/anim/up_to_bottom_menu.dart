...
class TopToBottomMenu extends StatefulWidget {
  final Widget child;
  final int index;
  final bool hovered;
  ...
  @override
  _TopToBottomMenuState createState() => _TopToBottomMenuState();
}

class _TopToBottomMenuState extends State<TopToBottomMenu>
              ...
              if (value.connectionState == ConnectionState.done) {
                return TweenAnimationBuilder(
                  ...
                  builder: (_, double value, _child) {
                    return UpToBottomAnimationTile(
                      value: value,
                      child: _child!,
                      index: i,
                    );
...
class UpToBottomAnimationTile extends StatelessWidget {
  final int index;
  final double value;
  final Widget child;

  const UpToBottomAnimationTile(
