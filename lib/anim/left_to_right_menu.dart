...
class LeftToRightMenu extends StatefulWidget {
  final Widget child;
  final int index;
  final bool hovered;
  ...
  @override
  _LeftToRightMenuState createState() => _LeftToRightMenuState();
}

class _LeftToRightMenuState extends State<LeftToRightMenu> with SingleTickerProviderStateMixin {
